...
public class NReachability {

    public typealias NetworkReachable = (NReachability) -> ()
    public typealias NetworkUnreachable = (NReachability) -> ()
...
public extension NReachability {
...
fileprivate extension NReachability {
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = NReachability.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: NReachability?
    init(reachability: NReachability) {
